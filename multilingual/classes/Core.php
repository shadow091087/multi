...
class Core {
	...
	public function runFront() {
		...
		if (array_key_exists($this->objUrl->cpage, Router::$_modules)) {
			...
			$file = ROOT_PATS.DS.'mod'.DS.Router::$_modules[$this->objUrl->cpage].'.php';
	...
	public function parseColumn() {
		...
		$array = array(
			'<img src="/media/images/red-hot-chili-papers.jpg" alt="Red Hot Chili Papers" 
			width="250" height="166" style="float:left;margin-botton:17px;" />',
			'<img src="/media/images/new-radicals.jpg" alt="New Radicals" 
			width="250" height="163" style="float:left;margin-botton:17px;" />',
			'<img src="/media/images/blur.jpg" alt="Blur" 
			width="250" height="132" style="float:left;margin-botton:17px;" />',
			'<img src="/media/images/henry-rollins.jpg" alt="Henry Rollins" 
			width="250" height="167" style="float:left;margin-botton:17px;" />',
		);
		$keys = array_rand($array, 3);
		$this->column = $array[$key[0]].$array[$key[1]].$array[$key[2]];
	}
